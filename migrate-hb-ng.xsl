...
&lt;<xsl:value-of select="$collectionURI"/>&gt; &lt;http://schema.org/dataset&gt; &lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$recordIdentifier"/>/about&gt; .
                ...
                <xsl:if test="current()/mods:titleInfo[@type='translated']/mods:title">
                    <xsl:call-template name="title-uuid">
                        ...
                        <xsl:with-param name="uri" select=" 'http://purl.org/dc/terms#title' "/>
                        <xsl:with-param name="subTitle"
                                        select="current()/mods:titleInfo[@type='translated']/mods:subTitle"/>
                        <xsl:with-param name="recordIdentifier" select="$recordIdentifier"/>
                    </xsl:call-template>
                </xsl:if>
                ...
                <xsl:if test="current()/mods:titleInfo[@type='uniform']/mods:title">
                    <xsl:call-template name="title-uuid">
                        ...
                        <xsl:with-param name="uri" select=" 'http://purl.org/dc/terms#title' "/>
                        <xsl:with-param name="subTitle"
                                        select="current()/mods:titleInfo[@type='uniform']/mods:subTitle"/>
                        <xsl:with-param name="recordIdentifier" select="$recordIdentifier"/>
                    </xsl:call-template>
                </xsl:if>
                ...
                <xsl:if test="current()/mods:titleInfo[@type='alternative']/mods:title">
                    <xsl:call-template name="title-uuid">
                        <xsl:with-param name="output"
                                        select="current()/mods:titleInfo[@type='alternative']/mods:title"/>
                        <xsl:with-param name="uri" select=" 'http://purl.org/dc/terms/alternative' "/>
                        <xsl:with-param name="subTitle"
                                        select="current()/mods:titleInfo[@type='alternative']/mods:subTitle"/>
                    </xsl:call-template>
                </xsl:if>
                ...
                <xsl:if test="current()/mods:relatedItem[@type='host']/mods:part/mods:date">
                    <xsl:call-template name="uuid">
                        <xsl:with-param name="output"
                                        select="current()/mods:relatedItem[@type='host']/mods:part/mods:date"/>
                        <xsl:with-param name="uri" select=" 'http://purl.org/dc/terms#issued' "/>
                        <xsl:with-param name="recordIdentifier" select="$recordIdentifier"/>
                    </xsl:call-template>
                </xsl:if>
                ...
                <xsl:if test="current()/mods:physicalDescription/mods:internetMediaType">
                    <xsl:call-template name="uuid">
                        <xsl:with-param name="output"
                                        select="current()/mods:physicalDescription/mods:internetMediaType"/>
                ...
                <xsl:if test="current()/mods:recordInfo/mods:recordCreationDate">
                    <xsl:call-template name="uuid">
                        ...
                        <xsl:with-param name="uri"
                                        select=" 'http://www.loc.gov/standards/mods/userguide/recordinfo.html#recordcreationdate' "/>
                        <xsl:with-param name="recordIdentifier" select="$recordIdentifier"/>
                    </xsl:call-template>
                </xsl:if>
                ...
                <xsl:if test="current()/mods:recordInfo/mods:recordChangeDate">
                    <xsl:call-template name="uuid">
                        ...
                        <xsl:with-param name="uri"
                                        select=" 'http://www.loc.gov/standards/mods/userguide/recordinfo.html#recordchangedate' "/>
                        <xsl:with-param name="recordIdentifier" select="$recordIdentifier"/>
                    </xsl:call-template>
                </xsl:if>
                ...
                <xsl:if test="current()/mods:originInfo/mods:place/mods:placeTerm[@type='text']">
                    <xsl:call-template name="uuid">
                        <xsl:with-param name="output"
                                        select="current()/mods:originInfo/mods:place/mods:placeTerm[@type='text']"/>
...
&lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$publisher-uuid"/>/about&gt; &lt;http://creativecommons.org/ns#attributionURL&gt; &lt;<xsl:value-of select="$ccAttributionURL" />&gt; .
&lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$publisher-uuid"/>/about&gt; &lt;http://creativecommons.org/ns#attributionName&gt; "<xsl:value-of select="$ccAttributionName" />" .
...
&lt;<xsl:value-of select="$collectionURI"/>&gt; &lt;http://schema.org/dataset&gt; &lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$publisher-uuid"/>/about&gt; .
}};
...
&lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$uuid"/>/about&gt; &lt;http://creativecommons.org/ns#attributionURL&gt; &lt;<xsl:value-of select="$ccAttributionURL" />&gt; .
&lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$uuid"/>/about&gt; &lt;http://creativecommons.org/ns#attributionName&gt; "<xsl:value-of select="$ccAttributionName" />" .
...
&lt;<xsl:value-of select="$collectionURI"/>&gt; &lt;http://schema.org/dataset&gt; &lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$uuid"/>/about&gt; .
}};
...
&lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$work-uuid"/>&gt; &lt;http://rdaregistry.info/Elements/w/subjectRelationship&gt; &lt;<xsl:value-of select="$baseuri"/><xsl:value-of select="$uuid"/>&gt; .
                ...
                <xsl:if test="current()/mods:accessCondition[@type='use and reproduction']">
                    <xsl:call-template name="uuid">
                        <xsl:with-param name="output"
                                        select="current()/mods:accessCondition[@type='use and reproduction']"/>
                ...
                <xsl:if test="current()/mods:accessCondition[@type='restriction on access']">
                    <xsl:call-template name="uuid">
                        <xsl:with-param name="output"
                                        select="current()/mods:accessCondition[@type='restriction on access']"/>
                        <xsl:with-param name="uri" select=" 'http://purl.org/dc/terms/accessRights' "/>
                        <xsl:with-param name="recordIdentifier" select="$recordIdentifier"/>
                    </xsl:call-template>
                </xsl:if>
